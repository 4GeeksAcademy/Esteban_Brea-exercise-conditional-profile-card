...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.lastName == null ? "Boilett" : variables.lastName
          ...
          <h2>${variables.role == null ? "Sin ocupacion" : variables.role}</h2>
          <h3>${variables.city == null ? "Sin ciudad" : variables.city} ${
    variables.country == null ? "Sin pais" : variables.country
  }</h3>
